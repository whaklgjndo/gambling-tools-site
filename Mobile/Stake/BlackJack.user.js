...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Stake/BlackJack.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Stake/BlackJack.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Stake Blackjack — Mobile] standalone build v6.10'); } catch (e) {}
    ...
    // ---- Perfect Blackjack (one platform-aware body, registered per site) ----
    register({
        id: 'stake-blackjack', name: 'Stake Blackjack', group: 'Stake',
        description: 'Basic-strategy advisor with optional auto-play.',
        matches: ['https://stake.com/casino/games/blackjack*', 'https://stake.us/casino/games/blackjack*',
                  'https://stake.bet/casino/games/blackjack*', 'https://stake.games/casino/games/blackjack*',
                  'https://staketr.com/casino/games/blackjack*', 'https://staketr2.com/casino/games/blackjack*',
                  'https://staketr3.com/casino/games/blackjack*', 'https://staketr4.com/casino/games/blackjack*',
                  'https://stake.bz/casino/games/blackjack*', 'https://stake.pet/casino/games/blackjack*', 'https://stake.jp/casino/games/blackjack*'],
        defaultEnabled: true
    });
