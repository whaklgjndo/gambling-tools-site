...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Stake/Mines.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Stake/Mines.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Stake Mines — Mobile] standalone build v6.12'); } catch (e) {}
    ...
    register({
        ...
        matches: ['https://stake.com/casino/games/mines*', 'https://stake.us/casino/games/mines*',
                  ...
                  'https://stake.bz/casino/games/mines*', 'https://stake.pet/casino/games/mines*', 'https://stake.jp/casino/games/mines*'],
        defaultEnabled: true
    });
