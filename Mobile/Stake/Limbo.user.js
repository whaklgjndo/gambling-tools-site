...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Stake/Limbo.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Stake/Limbo.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Stake Limbo — Mobile] standalone build v6.11'); } catch (e) {}
    ...
    register({
        ...
        matches: ['https://stake.com/casino/games/limbo*',
                  ...
                  'https://stake.pet/casino/games/limbo*', 'https://stake.jp/casino/games/limbo*'],
