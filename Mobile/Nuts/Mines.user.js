...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Nuts/Mines.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Nuts/Mines.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Nuts Mines — Mobile] standalone build v6.12'); } catch (e) {}
