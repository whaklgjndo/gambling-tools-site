...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Nuts/AutoVault.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Nuts/AutoVault.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Nuts Auto-Vault — Mobile] standalone build v6.11'); } catch (e) {}
