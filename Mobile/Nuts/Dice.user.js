...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Nuts/Dice.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Nuts/Dice.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Nuts Dice — Mobile] standalone build v6.12'); } catch (e) {}
    ...
    register({
        ...
        description: 'Manual / IOW / Smart / Advanced IOW bet-progression HUD for dice.',
