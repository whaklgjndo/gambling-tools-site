...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Shuffle/AutoVault.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Shuffle/AutoVault.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Shuffle Auto-Vault — Mobile] standalone build v6.12'); } catch (e) {}
