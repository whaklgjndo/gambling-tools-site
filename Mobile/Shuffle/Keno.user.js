...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Shuffle/Keno.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Shuffle/Keno.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Shuffle Keno — Mobile] standalone build v6.11'); } catch (e) {}
