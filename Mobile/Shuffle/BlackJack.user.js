...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Shuffle/BlackJack.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Shuffle/BlackJack.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Shuffle Blackjack — Mobile] standalone build v6.08'); } catch (e) {}
    ...
    register({
        id: 'shuffle-blackjack', name: 'Shuffle Blackjack', group: 'Shuffle',
        description: 'Basic-strategy advisor with optional auto-play.',
        matches: ['https://shuffle.com/games/originals/blackjack*', 'https://shuffle.us/games/originals/blackjack*'],
        defaultEnabled: true
    });
