...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Mobile/Shuffle/Dice.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Mobile/Shuffle/Dice.user.js
// ==/UserScript==

(function () {
    'use strict';

    try { console.log('[Shuffle Dice — Mobile] standalone build v6.11'); } catch (e) {}
