...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Shuffle/BlackJack.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Shuffle/BlackJack.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cShuffle Blackjack — Desktop — standalone build v3.37', 'color:#17c7b8;font-weight:800;font-size:13px');
    ...
    console.log('%c[Shuffle Blackjack — Desktop] loaded (' + TOOLS.length + ' tool slot(s)). Click \u2699 to toggle.', 'color:#8bc34a;font-weight:700;');
})();
