...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Shuffle/Limbo.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Shuffle/Limbo.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cShuffle Limbo — Desktop — standalone build v3.41', 'color:#17c7b8;font-weight:800;font-size:13px');
