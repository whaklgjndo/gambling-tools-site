...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Shuffle/Keno.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Shuffle/Keno.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cShuffle Keno — Desktop — standalone build v3.41', 'color:#17c7b8;font-weight:800;font-size:13px');
    ...
    function tool_shuffle_keno() {
        ...
        #keno-preset-gui .kp-min { background: none; border: none; color: #a78bfa; cursor: pointer; padding: 2px 6px; font-size: 16px; line-height: 1; border-radius: 4px; }
        #keno-preset-gui .kp-min:hover { color: #fff; background: rgba(168, 85, 247, 0.2); }
