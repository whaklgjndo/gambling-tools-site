...
(function () {
    ...
    console.log('%cShuffle Keno — Desktop — standalone build v3.39', 'color:#17c7b8;font-weight:800;font-size:13px');
    ...
    function tool_keno_hotspot() {
        ...
        function render() {
            ...
            if (!calibrated() && elStat && !elStat.textContent)
                setStatus('Click any number once so I can learn this site’s selected colour — until then draws are not recorded.');
        }
