...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Nuts/AutoVault.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Nuts/AutoVault.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cNuts Auto-Vault — Desktop — standalone build v3.37', 'color:#17c7b8;font-weight:800;font-size:13px');
