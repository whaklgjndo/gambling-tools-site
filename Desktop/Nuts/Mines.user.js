...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Nuts/Mines.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Nuts/Mines.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cNuts Mines — Desktop — standalone build v3.38', 'color:#17c7b8;font-weight:800;font-size:13px');
