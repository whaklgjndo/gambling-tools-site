...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Nuts/Dice.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Nuts/Dice.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cNuts Dice — Desktop — standalone build v3.41', 'color:#17c7b8;font-weight:800;font-size:13px');
