...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Nuts/Limbo.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Nuts/Limbo.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cNuts Limbo (Target) — Desktop — standalone build v3.39', 'color:#17c7b8;font-weight:800;font-size:13px');
...
// ================== SETTINGS & STATE ==================
    ...
    function isCurrentGameEnabledNuts() {
        ...
        let toolId = null;
        if (/\/dice(?:\/|$|\?|#)/i.test(path)) return false; // Limbo/Target standalone: never mount on Dice
...
`;
    ...
    console.log('%c[Nuts Limbo (Target) — Desktop] loaded (' + TOOLS.length + ' tool slot(s)). Click \u2699 to toggle.', 'color:#8bc34a;font-weight:700;');
})();
