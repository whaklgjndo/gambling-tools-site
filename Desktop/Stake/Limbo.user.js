...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/Limbo.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/Limbo.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cStake Limbo — Desktop — standalone build v3.40', 'color:#17c7b8;font-weight:800;font-size:13px');
...
${SHUF} .dt-terms-def, ${SHUF} .dt-terms-text { color: #cfc4f0 !important; }` : '';
    ...
    console.log('%c[Stake Limbo — Desktop] loaded (' + TOOLS.length + ' tool slot(s)). Click \u2699 to toggle.', 'color:#8bc34a;font-weight:700;');
})();
