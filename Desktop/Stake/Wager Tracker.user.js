...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/Wager%20Tracker.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/Wager%20Tracker.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cStake Wager Tracker — Desktop — standalone build v3.37', 'color:#17c7b8;font-weight:800;font-size:13px');
...
function tool_stake_7day_tracker() {
    ...
    register({
        ...
        matches: [
            ...
            'https://stake.bz/*', 'https://stake.pet/*', 'https://stake.jp/*'
        ],
