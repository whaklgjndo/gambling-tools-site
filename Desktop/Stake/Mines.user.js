...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/Mines.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/Mines.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cStake Mines — Desktop — standalone build v3.38', 'color:#17c7b8;font-weight:800;font-size:13px');
...
let isRunning = false;
    ...
    register({
        ...
        matches: [
            ...
            'https://stake.pet/casino/games/mines*', 'https://stake.jp/casino/games/mines*'
        ],
        runAt: 'document-end',
        defaultEnabled: true,
        group: 'Stake',
    ...
    console.log('%c[Stake Mines — Desktop] loaded (' + TOOLS.length + ' tool slot(s)). Click \u2699 to toggle.', 'color:#8bc34a;font-weight:700;');
})();
