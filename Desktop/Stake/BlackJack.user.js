...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/BlackJack.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/BlackJack.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cStake Blackjack — Desktop — standalone build v3.38', 'color:#17c7b8;font-weight:800;font-size:13px');
    ...
    console.log('%c[Stake Blackjack — Desktop] loaded (' + TOOLS.length + ' tool slot(s)). Click \u2699 to toggle.', 'color:#8bc34a;font-weight:700;');
})();
