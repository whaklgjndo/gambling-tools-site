...
// @noframes
// @updateURL    https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/Moles.user.js
// @downloadURL  https://whaklgjndo.github.io/gambling-tools-site/Desktop/Stake/Moles.user.js
// ==/UserScript==

(function () {
    'use strict';

    console.log('%cStake Moles — Desktop — standalone build v3.37', 'color:#17c7b8;font-weight:800;font-size:13px');
    ...
    register({
        ...
        matches: [
            ...
            'https://stake.pet/casino/games/moles*', 'https://stake.jp/casino/games/moles*'
        ],
        runAt: 'document-end',
        defaultEnabled: true,
        group: 'Stake',
